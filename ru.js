export default {
	...
	"config#componentOptions#IconButtonAction#pushImpulse#label": "", // Push Impulse Time
	"config#componentOptions#IconButtonAction#pushImpulse#info": "", // Impulse time after the push resets
