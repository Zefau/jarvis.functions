export default {
	...
	"config#componentOptions#SwitchAction#color#info": "Material-Brand-Color (Hex-Codes are not supported), siehe https://quasar.dev/style/color-palette#Color-List",
	...
	"config#componentOptions#LevelBody#markStep#info": "The displayed granularity with which the slider. This granularity regulates the number of marks to be displayed. The calculation is based on min/max values of the devices: (max-min) / marked-steps. For min=5, max=35 and a defined marked-step of 10 = (35-5)/10 = every 3. step a mark is displayed",
	...
	//"config#componentOptions#LastChangeBody#time#info": "The last change is based Die letzte Änderung bezieht sich auf die Zeit der letzten Veränderung des Wertes im Datenpunkt. Der Zeitstempel ist die letzte Aktualisierung des Datenpunkts der ggf. ohne Änderung des Wertes geschah.",
	...
	"config#componentOptions#TimePicker#nowButton#info": "Display Now Button to fill-in current time",
	...
	"config#componentOptions#TimePicker#nowButton#info": "Display Today Button to fill-in current date. NOT IN MINIMAL MODE!",
